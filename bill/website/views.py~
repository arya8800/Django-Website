...
def about_us_cust(request):
	...
	if account.acc_type=="CU":
		...
		return render(request,'about_us_cust.html',{'user_name':user_name})
...
def about_us_merch(request):
	...
	if account.acc_type=="ME":
		...
		return render(request,'about_us_merch.html',{'user_name':user_name})
...
def customer_home(request):
	...
	if account.acc_type=="CU":
		user_name="helo"
		return render(request,'customer_home.html',{'user_name':user_name})
...
def merchant_home(request):
	...
	if account.acc_type=="ME":
		...
		return render(request,'merchant_home.html',{'merchant_home':user_name})
